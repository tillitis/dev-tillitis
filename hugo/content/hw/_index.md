...
It is recommended to start handling touch events by acknowledge any
stray event prior to signal the user that a touch event is expected,
and then start waiting for the event.
